...
public class ListenerManager {
    ...
    private final com.visualization.cloud.sse.listener.JobListener jobListener;
    private final com.visualization.cloud.sse.listener.TriggerListener triggerListener;
    private final com.visualization.cloud.sse.listener.SchedulerListener schedulerListener;

    // 存储监听器状态
    private final Map<String, Boolean> listenerStates = new ConcurrentHashMap<>();

    public ListenerManager(Scheduler scheduler,
                           com.visualization.cloud.sse.listener.JobListener jobListener,
                           com.visualization.cloud.sse.listener.TriggerListener triggerListener,
